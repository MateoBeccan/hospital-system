...
/**
 * Criteria class for the {@link com.mycompany.hospital.domain.CanalSolicitud} entity. This class is used
 * in {@link com.mycompany.hospital.web.rest.CanalSolicitudResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /canal-solicituds?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CanalSolicitudCriteria implements Serializable, Criteria {
    ...
    public CanalSolicitudCriteria() {}

    public CanalSolicitudCriteria(CanalSolicitudCriteria other) {
    ...
    @Override
    public CanalSolicitudCriteria copy() {
        return new CanalSolicitudCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CanalSolicitudCriteria that = (CanalSolicitudCriteria) o;
        return (
