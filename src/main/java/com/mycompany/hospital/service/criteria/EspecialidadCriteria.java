...
/**
 * Criteria class for the {@link com.mycompany.hospital.domain.Especialidad} entity. This class is used
 * in {@link com.mycompany.hospital.web.rest.EspecialidadResource} to receive all the possible filtering options from
...
public class EspecialidadCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, codigo, nombre, descripcion, fechaAlta, fechaBaja, activa, distinct);
    }
