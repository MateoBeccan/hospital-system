...
/**
 * Criteria class for the {@link com.mycompany.hospital.domain.EstadoDiagnostico} entity. This class is used
 * in {@link com.mycompany.hospital.web.rest.EstadoDiagnosticoResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /estado-diagnosticos?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class EstadoDiagnosticoCriteria implements Serializable, Criteria {
    ...
    public EstadoDiagnosticoCriteria() {}

    public EstadoDiagnosticoCriteria(EstadoDiagnosticoCriteria other) {
    ...
    @Override
    public EstadoDiagnosticoCriteria copy() {
        return new EstadoDiagnosticoCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EstadoDiagnosticoCriteria that = (EstadoDiagnosticoCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, codigo, nombre, descripcion, activo, fechaAlta, fechaBaja, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "EstadoDiagnosticoCriteria{" +
