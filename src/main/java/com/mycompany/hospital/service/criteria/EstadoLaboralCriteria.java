...
/**
 * Criteria class for the {@link com.mycompany.hospital.domain.EstadoLaboral} entity. This class is used
 * in {@link com.mycompany.hospital.web.rest.EstadoLaboralResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /estado-laborals?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class EstadoLaboralCriteria implements Serializable, Criteria {
    ...
    public EstadoLaboralCriteria() {}

    public EstadoLaboralCriteria(EstadoLaboralCriteria other) {
    ...
    @Override
    public EstadoLaboralCriteria copy() {
        return new EstadoLaboralCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EstadoLaboralCriteria that = (EstadoLaboralCriteria) o;
        return (
