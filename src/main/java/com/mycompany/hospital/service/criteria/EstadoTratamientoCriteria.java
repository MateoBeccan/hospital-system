...
/**
 * Criteria class for the {@link com.mycompany.hospital.domain.EstadoTratamiento} entity. This class is used
 * in {@link com.mycompany.hospital.web.rest.EstadoTratamientoResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /estado-tratamientos?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class EstadoTratamientoCriteria implements Serializable, Criteria {
    ...
    public EstadoTratamientoCriteria() {}

    public EstadoTratamientoCriteria(EstadoTratamientoCriteria other) {
    ...
    @Override
    public EstadoTratamientoCriteria copy() {
        return new EstadoTratamientoCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EstadoTratamientoCriteria that = (EstadoTratamientoCriteria) o;
        return (
    ...
    public String toString() {
        return "EstadoTratamientoCriteria{" +
