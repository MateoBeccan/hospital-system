...
/**
 * Criteria class for the {@link com.mycompany.hospital.domain.EstadoTurno} entity. This class is used
 * in {@link com.mycompany.hospital.web.rest.EstadoTurnoResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /estado-turnos?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class EstadoTurnoCriteria implements Serializable, Criteria {
    ...
    public EstadoTurnoCriteria() {}

    public EstadoTurnoCriteria(EstadoTurnoCriteria other) {
    ...
    @Override
    public EstadoTurnoCriteria copy() {
        return new EstadoTurnoCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EstadoTurnoCriteria that = (EstadoTurnoCriteria) o;
        return (
