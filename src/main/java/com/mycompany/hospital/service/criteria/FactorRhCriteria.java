...
/**
 * Criteria class for the {@link com.mycompany.hospital.domain.FactorRh} entity. This class is used
 * in {@link com.mycompany.hospital.web.rest.FactorRhResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /factor-rhs?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class FactorRhCriteria implements Serializable, Criteria {
    ...
    public FactorRhCriteria() {}

    public FactorRhCriteria(FactorRhCriteria other) {
    ...
    @Override
    public FactorRhCriteria copy() {
        return new FactorRhCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final FactorRhCriteria that = (FactorRhCriteria) o;
        return (
