...
/**
 * Criteria class for the {@link com.mycompany.hospital.domain.GrupoSanguineo} entity. This class is used
 * in {@link com.mycompany.hospital.web.rest.GrupoSanguineoResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /grupo-sanguineos?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class GrupoSanguineoCriteria implements Serializable, Criteria {
    ...
    public GrupoSanguineoCriteria() {}

    public GrupoSanguineoCriteria(GrupoSanguineoCriteria other) {
    ...
    @Override
    public GrupoSanguineoCriteria copy() {
        return new GrupoSanguineoCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final GrupoSanguineoCriteria that = (GrupoSanguineoCriteria) o;
        return (
