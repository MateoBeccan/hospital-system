...
/**
 * Criteria class for the {@link com.mycompany.hospital.domain.Medico} entity. This class is used
 * in {@link com.mycompany.hospital.web.rest.MedicoResource} to receive all the possible filtering options from
...
public class MedicoCriteria implements Serializable, Criteria {
    ...
    private StringFilter firmaDigital;

    private BooleanFilter atiendeConsultorio;
    ...
    public MedicoCriteria(MedicoCriteria other) {
        ...
        this.firmaDigital = other.optionalFirmaDigital().map(StringFilter::copy).orElse(null);
        this.atiendeConsultorio = other.optionalAtiendeConsultorio().map(BooleanFilter::copy).orElse(null);
    ...
    public StringFilter getFirmaDigital() {
        return firmaDigital;
    }

    public Optional<StringFilter> optionalFirmaDigital() {
        return Optional.ofNullable(firmaDigital);
    }

    public StringFilter firmaDigital() {
        if (firmaDigital == null) {
            setFirmaDigital(new StringFilter());
        }
        return firmaDigital;
    }

    public void setFirmaDigital(StringFilter firmaDigital) {
        this.firmaDigital = firmaDigital;
    }

    public BooleanFilter getAtiendeConsultorio() {
        return atiendeConsultorio;
    }

    public Optional<BooleanFilter> optionalAtiendeConsultorio() {
        return Optional.ofNullable(atiendeConsultorio);
    }

    public BooleanFilter atiendeConsultorio() {
        if (atiendeConsultorio == null) {
            setAtiendeConsultorio(new BooleanFilter());
        }
        return atiendeConsultorio;
    }

    public void setAtiendeConsultorio(BooleanFilter atiendeConsultorio) {
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(firmaDigital, that.firmaDigital) &&
            Objects.equals(atiendeConsultorio, that.atiendeConsultorio) &&
    ...
    public String toString() {
        return "MedicoCriteria{" +
            ...
            optionalFirmaDigital().map(f -> "firmaDigital=" + f + ", ").orElse("") +
            optionalAtiendeConsultorio().map(f -> "atiendeConsultorio=" + f + ", ").orElse("") +
