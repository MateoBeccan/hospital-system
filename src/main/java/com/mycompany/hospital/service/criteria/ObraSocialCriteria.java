...
/**
 * Criteria class for the {@link com.mycompany.hospital.domain.ObraSocial} entity. This class is used
 * in {@link com.mycompany.hospital.web.rest.ObraSocialResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /obra-socials?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ObraSocialCriteria implements Serializable, Criteria {
    ...
    public ObraSocialCriteria() {}

    public ObraSocialCriteria(ObraSocialCriteria other) {
    ...
    @Override
    public ObraSocialCriteria copy() {
        return new ObraSocialCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ObraSocialCriteria that = (ObraSocialCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, codigo, nombre, telefono, email, direccion, activo, fechaAlta, fechaBaja, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "ObraSocialCriteria{" +
