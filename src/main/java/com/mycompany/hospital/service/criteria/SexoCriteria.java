...
/**
 * Criteria class for the {@link com.mycompany.hospital.domain.Sexo} entity. This class is used
 * in {@link com.mycompany.hospital.web.rest.SexoResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /sexos?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class SexoCriteria implements Serializable, Criteria {
    ...
    public SexoCriteria(SexoCriteria other) {
    ...
    @Override
    public SexoCriteria copy() {
        return new SexoCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final SexoCriteria that = (SexoCriteria) o;
        return (
