...
/**
 * Criteria class for the {@link com.mycompany.hospital.domain.TipoDiagnostico} entity. This class is used
 * in {@link com.mycompany.hospital.web.rest.TipoDiagnosticoResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /tipo-diagnosticos?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class TipoDiagnosticoCriteria implements Serializable, Criteria {
    ...
    public TipoDiagnosticoCriteria() {}

    public TipoDiagnosticoCriteria(TipoDiagnosticoCriteria other) {
    ...
    @Override
    public TipoDiagnosticoCriteria copy() {
        return new TipoDiagnosticoCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final TipoDiagnosticoCriteria that = (TipoDiagnosticoCriteria) o;
        return (
    ...
    public String toString() {
        return "TipoDiagnosticoCriteria{" +
