...
/**
 * Criteria class for the {@link com.mycompany.hospital.domain.TipoDocumento} entity. This class is used
 * in {@link com.mycompany.hospital.web.rest.TipoDocumentoResource} to receive all the possible filtering options from
...
public class TipoDocumentoCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, codigo, nombre, sigla, descripcion, activo, fechaAlta, fechaBaja, distinct);
    }
