...
/**
 * Criteria class for the {@link com.mycompany.hospital.domain.TurnoLaboral} entity. This class is used
 * in {@link com.mycompany.hospital.web.rest.TurnoLaboralResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /turno-laborals?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class TurnoLaboralCriteria implements Serializable, Criteria {
    ...
    public TurnoLaboralCriteria() {}

    public TurnoLaboralCriteria(TurnoLaboralCriteria other) {
        ...
        this.horaFin = other.optionalHoraFin().map(StringFilter::copy).orElse(null);
    ...
    @Override
    public TurnoLaboralCriteria copy() {
        return new TurnoLaboralCriteria(this);
    }
    ...
    public Optional<StringFilter> optionalHoraFin() {
        return Optional.ofNullable(horaFin);
    }

    public StringFilter horaFin() {
        if (horaFin == null) {
            setHoraFin(new StringFilter());
        }
        return horaFin;
    }
    ...
    public boolean equals(Object o) {
        ...
        final TurnoLaboralCriteria that = (TurnoLaboralCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, codigo, nombre, horaInicio, horaFin, descripcion, activo, fechaAlta, fechaBaja, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "TurnoLaboralCriteria{" +
            ...
            optionalHoraFin().map(f -> "horaFin=" + f + ", ").orElse("") +
