...
import com.mycompany.hospital.service.CiudadQueryService;
import com.mycompany.hospital.service.CiudadService;
...
/**
 * REST controller for managing {@link com.mycompany.hospital.domain.Ciudad}.
 */
@RestController
...
public class CiudadResource {
    ...
    public ResponseEntity<CiudadDTO> createCiudad(@Valid @RequestBody CiudadDTO ciudadDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/ciudads/" + ciudadDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, ciudadDTO.getId().toString()))
            .body(ciudadDTO);
    }
    ...
    public ResponseEntity<CiudadDTO> updateCiudad(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, ciudadDTO.getId().toString()))
            .body(ciudadDTO);
    }
    ...
    public ResponseEntity<CiudadDTO> partialUpdateCiudad(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, ciudadDTO.getId().toString())
        );
    }
