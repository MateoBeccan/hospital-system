...
import com.mycompany.hospital.service.EmpleadoQueryService;
import com.mycompany.hospital.service.EmpleadoService;
...
/**
 * REST controller for managing {@link com.mycompany.hospital.domain.Empleado}.
 */
@RestController
...
public class EmpleadoResource {
    ...
    public ResponseEntity<List<EmpleadoDTO>> getAllEmpleados(
        EmpleadoCriteria criteria,
        @org.springdoc.core.annotations.ParameterObject Pageable pageable
    ) {
        LOG.debug("REST request to get Empleados by criteria: {}", criteria);

        Page<EmpleadoDTO> page = empleadoQueryService.findByCriteria(criteria, pageable);
