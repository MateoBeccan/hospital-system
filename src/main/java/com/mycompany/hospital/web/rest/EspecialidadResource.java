...
import com.mycompany.hospital.service.EspecialidadQueryService;
import com.mycompany.hospital.service.EspecialidadService;
...
/**
 * REST controller for managing {@link com.mycompany.hospital.domain.Especialidad}.
 */
@RestController
...
public class EspecialidadResource {
    ...
    public ResponseEntity<EspecialidadDTO> createEspecialidad(@Valid @RequestBody EspecialidadDTO especialidadDTO)
        ...
        return ResponseEntity.created(new URI("/api/especialidads/" + especialidadDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, especialidadDTO.getId().toString()))
    ...
    public ResponseEntity<EspecialidadDTO> updateEspecialidad(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, especialidadDTO.getId().toString()))
            .body(especialidadDTO);
    }
    ...
    public ResponseEntity<EspecialidadDTO> partialUpdateEspecialidad(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, especialidadDTO.getId().toString())
        );
    }
