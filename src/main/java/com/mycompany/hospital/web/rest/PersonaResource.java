...
import com.mycompany.hospital.service.PersonaQueryService;
import com.mycompany.hospital.service.PersonaService;
...
/**
 * REST controller for managing {@link com.mycompany.hospital.domain.Persona}.
 */
@RestController
...
public class PersonaResource {
    ...
    public ResponseEntity<PersonaDTO> createPersona(@Valid @RequestBody PersonaDTO personaDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/personas/" + personaDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, personaDTO.getId().toString()))
            .body(personaDTO);
    }
    ...
    public ResponseEntity<PersonaDTO> partialUpdatePersona(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, personaDTO.getId().toString())
        );
    }
