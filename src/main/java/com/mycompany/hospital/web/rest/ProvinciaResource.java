...
import com.mycompany.hospital.service.ProvinciaQueryService;
import com.mycompany.hospital.service.ProvinciaService;
...
/**
 * REST controller for managing {@link com.mycompany.hospital.domain.Provincia}.
 */
@RestController
...
public class ProvinciaResource {
    ...
    public ResponseEntity<ProvinciaDTO> createProvincia(@Valid @RequestBody ProvinciaDTO provinciaDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/provincias/" + provinciaDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, provinciaDTO.getId().toString()))
            .body(provinciaDTO);
    }
