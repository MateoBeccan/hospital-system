...
import com.mycompany.hospital.service.SignosVitalesQueryService;
import com.mycompany.hospital.service.SignosVitalesService;
import com.mycompany.hospital.service.criteria.SignosVitalesCriteria;
...
/**
 * REST controller for managing {@link com.mycompany.hospital.domain.SignosVitales}.
 */
@RestController
...
public class SignosVitalesResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<SignosVitalesDTO> createSignosVitales(@Valid @RequestBody SignosVitalesDTO signosVitalesDTO)
        ...
        return ResponseEntity.created(new URI("/api/signos-vitales/" + signosVitalesDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, signosVitalesDTO.getId().toString()))
    ...
    public ResponseEntity<SignosVitalesDTO> updateSignosVitales(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, signosVitalesDTO.getId().toString()))
            .body(signosVitalesDTO);
    }
    ...
    public ResponseEntity<SignosVitalesDTO> partialUpdateSignosVitales(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, signosVitalesDTO.getId().toString())
        );
    }

    /**
     * {@code GET  /signos-vitales} : get all the Signos Vitales.
     *
     * @param pageable the pagination information.
     * @param criteria the criteria which the requested entities should match.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of Signos Vitales in body.
     */
    @GetMapping("")
    public ResponseEntity<List<SignosVitalesDTO>> getAllSignosVitaleses(
        SignosVitalesCriteria criteria,
        @org.springdoc.core.annotations.ParameterObject Pageable pageable
    ) {
        LOG.debug("REST request to get SignosVitaleses by criteria: {}", criteria);
    ...
    /**
     * {@code GET  /signos-vitales/count} : count all the signosVitaleses.
     *
     * @param criteria the criteria which the requested entities should match.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the count in body.
     */
    @GetMapping("/count")
    public ResponseEntity<Long> countSignosVitaleses(SignosVitalesCriteria criteria) {
        LOG.debug("REST request to count SignosVitaleses by criteria: {}", criteria);
