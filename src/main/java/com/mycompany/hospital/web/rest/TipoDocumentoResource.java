...
import com.mycompany.hospital.service.TipoDocumentoQueryService;
import com.mycompany.hospital.service.TipoDocumentoService;
...
/**
 * REST controller for managing {@link com.mycompany.hospital.domain.TipoDocumento}.
 */
@RestController
...
public class TipoDocumentoResource {
    ...
    public TipoDocumentoResource(
        ...
        TipoDocumentoQueryService tipoDocumentoQueryService
    ) {
    ...
    public ResponseEntity<List<TipoDocumentoDTO>> getAllTipoDocumentos(
        TipoDocumentoCriteria criteria,
        @org.springdoc.core.annotations.ParameterObject Pageable pageable
    ) {
        LOG.debug("REST request to get TipoDocumentos by criteria: {}", criteria);

        Page<TipoDocumentoDTO> page = tipoDocumentoQueryService.findByCriteria(criteria, pageable);
