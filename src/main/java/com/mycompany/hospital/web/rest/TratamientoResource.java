...
import com.mycompany.hospital.service.TratamientoQueryService;
import com.mycompany.hospital.service.TratamientoService;
...
/**
 * REST controller for managing {@link com.mycompany.hospital.domain.Tratamiento}.
 */
@RestController
...
public class TratamientoResource {
    ...
    public ResponseEntity<TratamientoDTO> createTratamiento(@Valid @RequestBody TratamientoDTO tratamientoDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/tratamientos/" + tratamientoDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, tratamientoDTO.getId().toString()))
            .body(tratamientoDTO);
    }
    ...
    public ResponseEntity<TratamientoDTO> updateTratamiento(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, tratamientoDTO.getId().toString()))
            .body(tratamientoDTO);
    }
    ...
    public ResponseEntity<TratamientoDTO> partialUpdateTratamiento(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, tratamientoDTO.getId().toString())
        );
    }
