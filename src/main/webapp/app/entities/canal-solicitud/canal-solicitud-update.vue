  ...
  <div class="d-flex justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2 id="hospitalApp.canalSolicitud.home.createOrEditLabel" data-cy="CanalSolicitudCreateUpdateHeading">
          Crear o editar Canal Solicitud
        </h2>
        <div>
          <div class="mb-3" v-if="canalSolicitud.id">
            <label for="id">ID</label>
            <input type="text" class="form-control" id="id" name="id" v-model="canalSolicitud.id" readonly />
          </div>
          <div class="mb-3">
            <label class="form-control-label" for="canal-solicitud">Codigo</label>
            <input
              type="text"
              class="form-control"
              name="codigo"
              id="canal-solicitud-codigo"
              data-cy="codigo"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="canal-solicitud">Nombre</label>
            <input
              type="text"
              class="form-control"
              name="nombre"
              id="canal-solicitud-nombre"
              data-cy="nombre"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="canal-solicitud">Descripcion</label>
            <input
              type="text"
              class="form-control"
              name="descripcion"
              id="canal-solicitud-descripcion"
              data-cy="descripcion"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="canal-solicitud">Activo</label>
            <input
              type="checkbox"
              class="form-check"
              name="activo"
              id="canal-solicitud-activo"
              data-cy="activo"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="canal-solicitud">Fecha Alta</label>
            <b-input-group class="mb-3">
              <b-input-group-prepend>
                <b-form-datepicker
                  aria-controls="canal-solicitud-fechaAlta"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="canal-solicitud">Fecha Baja</label>
            <b-input-group class="mb-3">
              <b-input-group-prepend>
                <b-form-datepicker
                  aria-controls="canal-solicitud-fechaBaja"
...
<script lang="ts" src="./canal-solicitud-update.component.ts"></script>
