...
import Ciudad from './ciudad.vue';

type CiudadComponentType = InstanceType<typeof Ciudad>;
...
describe('Component Tests', () => {
  ...
  describe('Ciudad Management Component', () => {
    ...
    let mountOptions: MountingOptions<CiudadComponentType>['global'];
    ...
    describe('Mount', () => {
      it('Should call load all on init', async () => {
        ...
        // WHEN
        const wrapper = shallowMount(Ciudad, { global: mountOptions });
        const comp = wrapper.vm;
        await comp.$nextTick();

        // THEN
        expect(ciudadServiceStub.retrieve.calledOnce).toBeTruthy();
      ...
      it('should calculate the sort attribute for an id', async () => {
        ...
        // THEN
        expect(ciudadServiceStub.retrieve.lastCall.firstArg).toMatchObject({
          sort: ['id,asc'],
        });
      });
    });
    describe('Handles', () => {
      let comp: CiudadComponentType;
      ...
      beforeEach(async () => {
        ...
        ciudadServiceStub.retrieve.resolves({ headers: {}, data: [] });
      });
