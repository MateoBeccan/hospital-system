...
export default class ConsultaService {
  find(id: number): Promise<IConsulta> {
  ...
  create(entity: IConsulta): Promise<IConsulta> {
    return new Promise<IConsulta>((resolve, reject) => {
      axios
  ...
  update(entity: IConsulta): Promise<IConsulta> {
    return new Promise<IConsulta>((resolve, reject) => {
      axios
  ...
  partialUpdate(entity: IConsulta): Promise<IConsulta> {
    return new Promise<IConsulta>((resolve, reject) => {
      axios
