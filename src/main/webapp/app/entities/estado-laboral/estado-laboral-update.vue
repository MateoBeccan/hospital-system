  ...
  <div class="d-flex justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2 id="hospitalApp.estadoLaboral.home.createOrEditLabel" data-cy="EstadoLaboralCreateUpdateHeading">
          Crear o editar Estado Laboral
        </h2>
        <div>
          <div class="mb-3" v-if="estadoLaboral.id">
            <label for="id">ID</label>
            <input type="text" class="form-control" id="id" name="id" v-model="estadoLaboral.id" readonly />
          </div>
          <div class="mb-3">
            <label class="form-control-label" for="estado-laboral">Codigo</label>
            <input
              type="text"
              class="form-control"
              name="codigo"
              id="estado-laboral-codigo"
              data-cy="codigo"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="estado-laboral">Nombre</label>
            <input
              type="text"
              class="form-control"
              name="nombre"
              id="estado-laboral-nombre"
              data-cy="nombre"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="estado-laboral">Descripcion</label>
            <input
              type="text"
              class="form-control"
              name="descripcion"
              id="estado-laboral-descripcion"
              data-cy="descripcion"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="estado-laboral">Fecha Alta</label>
            <b-input-group class="mb-3">
              <b-input-group-prepend>
                <b-form-datepicker
                  aria-controls="estado-laboral-fechaAlta"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="estado-laboral">Fecha Baja</label>
            <b-input-group class="mb-3">
              <b-input-group-prepend>
                <b-form-datepicker
                  aria-controls="estado-laboral-fechaBaja"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="estado-laboral">Activo</label>
            <input
              type="checkbox"
              class="form-check"
              name="activo"
              id="estado-laboral-activo"
              data-cy="activo"
...
<script lang="ts" src="./estado-laboral-update.component.ts"></script>
