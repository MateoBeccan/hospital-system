  ...
  <div class="d-flex justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2 id="hospitalApp.estadoTurno.home.createOrEditLabel" data-cy="EstadoTurnoCreateUpdateHeading">Crear o editar Estado Turno</h2>
        <div>
          <div class="mb-3" v-if="estadoTurno.id">
            <label for="id">ID</label>
            <input type="text" class="form-control" id="id" name="id" v-model="estadoTurno.id" readonly />
          </div>
          <div class="mb-3">
            <label class="form-control-label" for="estado-turno">Codigo</label>
            <input
              type="text"
              class="form-control"
              name="codigo"
              id="estado-turno-codigo"
              data-cy="codigo"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="estado-turno">Nombre</label>
            <input
              type="text"
              class="form-control"
              name="nombre"
              id="estado-turno-nombre"
              data-cy="nombre"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="estado-turno">Descripcion</label>
            <input
              type="text"
              class="form-control"
              name="descripcion"
              id="estado-turno-descripcion"
              data-cy="descripcion"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="estado-turno">Activo</label>
            <input
              type="checkbox"
              class="form-check"
              name="activo"
              id="estado-turno-activo"
              data-cy="activo"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="estado-turno">Fecha Alta</label>
            <b-input-group class="mb-3">
              <b-input-group-prepend>
                <b-form-datepicker
                  aria-controls="estado-turno-fechaAlta"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="estado-turno">Fecha Baja</label>
            <b-input-group class="mb-3">
              <b-input-group-prepend>
                <b-form-datepicker
                  aria-controls="estado-turno-fechaBaja"
...
<script lang="ts" src="./estado-turno-update.component.ts"></script>
