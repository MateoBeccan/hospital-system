  ...
  <div class="d-flex justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2 id="hospitalApp.factorRh.home.createOrEditLabel" data-cy="FactorRhCreateUpdateHeading">Crear o editar Factor Rh</h2>
        <div>
          <div class="mb-3" v-if="factorRh.id">
            <label for="id">ID</label>
            <input type="text" class="form-control" id="id" name="id" v-model="factorRh.id" readonly />
          </div>
          <div class="mb-3">
            <label class="form-control-label" for="factor-rh">Codigo</label>
            <input
              type="text"
              class="form-control"
              name="codigo"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="factor-rh">Nombre</label>
            <input
              type="text"
              class="form-control"
              name="nombre"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="factor-rh">Descripcion</label>
            <input
              type="text"
              class="form-control"
              name="descripcion"
              id="factor-rh-descripcion"
              data-cy="descripcion"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="factor-rh">Activo</label>
            <input
              type="checkbox"
              class="form-check"
              name="activo"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="factor-rh">Fecha Alta</label>
            <b-input-group class="mb-3">
              <b-input-group-prepend>
                <b-form-datepicker
                  aria-controls="factor-rh-fechaAlta"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="factor-rh">Fecha Baja</label>
            <b-input-group class="mb-3">
              <b-input-group-prepend>
                <b-form-datepicker
                  aria-controls="factor-rh-fechaBaja"
...
<script lang="ts" src="./factor-rh-update.component.ts"></script>
