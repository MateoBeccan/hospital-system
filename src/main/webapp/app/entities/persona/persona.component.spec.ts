...
type PersonaComponentType = InstanceType<typeof Persona>;
...
describe('Component Tests', () => {
  ...
  describe('Persona Management Component', () => {
    ...
    let mountOptions: MountingOptions<PersonaComponentType>['global'];
    ...
    describe('Mount', () => {
      it('Should call load all on init', async () => {
        ...
        // WHEN
        const wrapper = shallowMount(Persona, { global: mountOptions });
        const comp = wrapper.vm;
        await comp.$nextTick();

        // THEN
        expect(personaServiceStub.retrieve.calledOnce).toBeTruthy();
      ...
      it('should calculate the sort attribute for an id', async () => {
        ...
        // THEN
        expect(personaServiceStub.retrieve.lastCall.firstArg).toMatchObject({
          sort: ['id,asc'],
        });
      });
    });
    describe('Handles', () => {
      let comp: PersonaComponentType;
      ...
      beforeEach(async () => {
        ...
        personaServiceStub.retrieve.resolves({ headers: {}, data: [] });
      });
      ...
      it('should not load a page if the page is the same as the previous page', () => {
        ...
        // THEN
        expect(personaServiceStub.retrieve.called).toBeFalsy();
      });
