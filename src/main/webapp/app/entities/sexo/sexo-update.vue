  ...
  <div class="d-flex justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2 id="hospitalApp.sexo.home.createOrEditLabel" data-cy="SexoCreateUpdateHeading">Crear o editar Sexo</h2>
        <div>
          <div class="mb-3" v-if="sexo.id">
            <label for="id">ID</label>
            <input type="text" class="form-control" id="id" name="id" v-model="sexo.id" readonly />
          </div>
          <div class="mb-3">
            <label class="form-control-label" for="sexo">Codigo</label>
            <input
              type="text"
              class="form-control"
              name="codigo"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="sexo">Nombre</label>
            <input
              type="text"
              class="form-control"
              name="nombre"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="sexo">Descripcion</label>
            <input
              type="text"
              class="form-control"
              name="descripcion"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="sexo">Fecha Alta</label>
            <b-input-group class="mb-3">
              <b-input-group-prepend>
                <b-form-datepicker
                  aria-controls="sexo-fechaAlta"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="sexo">Fecha Baja</label>
            <b-input-group class="mb-3">
              <b-input-group-prepend>
                <b-form-datepicker
                  aria-controls="sexo-fechaBaja"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="sexo">Activo</label>
            <input
              type="checkbox"
              class="form-check"
              name="activo"
...
<script lang="ts" src="./sexo-update.component.ts"></script>
