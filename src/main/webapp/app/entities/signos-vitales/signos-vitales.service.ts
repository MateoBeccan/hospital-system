...
export default class SignosVitalesService {
  find(id: number): Promise<ISignosVitales> {
  ...
  create(entity: ISignosVitales): Promise<ISignosVitales> {
    return new Promise<ISignosVitales>((resolve, reject) => {
      axios
  ...
  update(entity: ISignosVitales): Promise<ISignosVitales> {
    return new Promise<ISignosVitales>((resolve, reject) => {
      axios
  ...
  partialUpdate(entity: ISignosVitales): Promise<ISignosVitales> {
    return new Promise<ISignosVitales>((resolve, reject) => {
      axios
