  ...
  <div class="d-flex justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2 id="hospitalApp.tipoDiagnostico.home.createOrEditLabel" data-cy="TipoDiagnosticoCreateUpdateHeading">
          Crear o editar Tipo Diagnostico
        </h2>
        <div>
          <div class="mb-3" v-if="tipoDiagnostico.id">
            <label for="id">ID</label>
            <input type="text" class="form-control" id="id" name="id" v-model="tipoDiagnostico.id" readonly />
          </div>
          <div class="mb-3">
            <label class="form-control-label" for="tipo-diagnostico">Codigo</label>
            <input
              type="text"
              class="form-control"
              name="codigo"
              id="tipo-diagnostico-codigo"
              data-cy="codigo"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="tipo-diagnostico">Nombre</label>
            <input
              type="text"
              class="form-control"
              name="nombre"
              id="tipo-diagnostico-nombre"
              data-cy="nombre"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="tipo-diagnostico">Descripcion</label>
            <input
              type="text"
              class="form-control"
              name="descripcion"
              id="tipo-diagnostico-descripcion"
              data-cy="descripcion"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="tipo-diagnostico">Activo</label>
            <input
              type="checkbox"
              class="form-check"
              name="activo"
              id="tipo-diagnostico-activo"
              data-cy="activo"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="tipo-diagnostico">Fecha Alta</label>
            <b-input-group class="mb-3">
              <b-input-group-prepend>
                <b-form-datepicker
                  aria-controls="tipo-diagnostico-fechaAlta"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="tipo-diagnostico">Fecha Baja</label>
            <b-input-group class="mb-3">
              <b-input-group-prepend>
                <b-form-datepicker
                  aria-controls="tipo-diagnostico-fechaBaja"
...
<script lang="ts" src="./tipo-diagnostico-update.component.ts"></script>
