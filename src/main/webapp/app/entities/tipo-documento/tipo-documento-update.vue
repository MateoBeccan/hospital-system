  ...
  <div class="d-flex justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2 id="hospitalApp.tipoDocumento.home.createOrEditLabel" data-cy="TipoDocumentoCreateUpdateHeading">
        ...
        <div>
          ...
          <div class="mb-3">
            <label class="form-control-label" for="tipo-documento">Nombre</label>
            <input
              type="text"
              class="form-control"
              name="nombre"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="tipo-documento">Sigla</label>
            <input
              type="text"
              class="form-control"
              name="sigla"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="tipo-documento">Activo</label>
            <input
              type="checkbox"
              class="form-check"
              name="activo"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="tipo-documento">Fecha Alta</label>
            <b-input-group class="mb-3">
              <b-input-group-prepend>
                <b-form-datepicker
                  aria-controls="tipo-documento-fechaAlta"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="tipo-documento">Fecha Baja</label>
            <b-input-group class="mb-3">
              <b-input-group-prepend>
                <b-form-datepicker
                  aria-controls="tipo-documento-fechaBaja"
