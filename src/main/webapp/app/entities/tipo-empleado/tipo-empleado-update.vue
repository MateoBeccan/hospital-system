  ...
  <div class="d-flex justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2 id="hospitalApp.tipoEmpleado.home.createOrEditLabel" data-cy="TipoEmpleadoCreateUpdateHeading">Crear o editar Tipo Empleado</h2>
        <div>
          <div class="mb-3" v-if="tipoEmpleado.id">
            <label for="id">ID</label>
            <input type="text" class="form-control" id="id" name="id" v-model="tipoEmpleado.id" readonly />
          </div>
          <div class="mb-3">
            <label class="form-control-label" for="tipo-empleado">Codigo</label>
            <input
              type="text"
              class="form-control"
              name="codigo"
              id="tipo-empleado-codigo"
              data-cy="codigo"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="tipo-empleado">Nombre</label>
            <input
              type="text"
              class="form-control"
              name="nombre"
              id="tipo-empleado-nombre"
              data-cy="nombre"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="tipo-empleado">Descripcion</label>
            <input
              type="text"
              class="form-control"
              name="descripcion"
              id="tipo-empleado-descripcion"
              data-cy="descripcion"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="tipo-empleado">Fecha Alta</label>
            <b-input-group class="mb-3">
              <b-input-group-prepend>
                <b-form-datepicker
                  aria-controls="tipo-empleado-fechaAlta"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="tipo-empleado">Fecha Baja</label>
            <b-input-group class="mb-3">
              <b-input-group-prepend>
                <b-form-datepicker
                  aria-controls="tipo-empleado-fechaBaja"
          ...
          <div class="mb-3">
            <label class="form-control-label" for="tipo-empleado">Activo</label>
            <input
              type="checkbox"
              class="form-check"
              name="activo"
              id="tipo-empleado-activo"
              data-cy="activo"
...
<script lang="ts" src="./tipo-empleado-update.component.ts"></script>
